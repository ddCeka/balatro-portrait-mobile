...
function Card:align_h_popup()
        ...
        local popup_direction = (self.children.buy_button or (self.area and self.area.config.view_deck) or (self.area and self.area.config.type == 'shop')) and 'cl' or 
                                ...
                                'tm'
        local offset_y_tm = focused_ui and (self.area and self.area == G.hand and -0.08 or -0.15) or -0.13
        local offset_y_bm = focused_ui and 0.12 or 0.1
        local offset_x = popup_direction ~= 'cl' and 0 or
        ...
        return {
            ...
            offset = {
                x = offset_x,
                y = focused_ui and (
                            popup_direction == 'tm' and offset_y_tm or
                            popup_direction == 'bm' and offset_y_bm or
                            0
                        ) or
                    popup_direction == 'tm' and offset_y_tm or
                    popup_direction == 'bm' and offset_y_bm or
